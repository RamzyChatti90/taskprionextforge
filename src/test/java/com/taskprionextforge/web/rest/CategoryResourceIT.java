...
import static com.taskprionextforge.domain.CategoryAsserts.*;
...
import com.taskprionextforge.repository.CategoryRepository;
import com.taskprionextforge.service.dto.CategoryDTO;
import com.taskprionextforge.service.mapper.CategoryMapper;
...
class CategoryResourceIT {
    ...
    public static Category createEntity() {
        return new Category().name(DEFAULT_NAME).color(DEFAULT_COLOR).icon(DEFAULT_ICON);
    }
    ...
    public static Category createUpdatedEntity() {
        return new Category().name(UPDATED_NAME).color(UPDATED_COLOR).icon(UPDATED_ICON);
    }
