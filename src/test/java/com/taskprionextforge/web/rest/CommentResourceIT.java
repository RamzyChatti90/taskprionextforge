...
import static com.taskprionextforge.domain.CommentAsserts.*;
import static com.taskprionextforge.web.rest.TestUtil.createUpdateProxyForBean;
...
import com.taskprionextforge.IntegrationTest;
...
class CommentResourceIT {
    ...
    public static Comment createEntity() {
        return new Comment().author(DEFAULT_AUTHOR).content(DEFAULT_CONTENT).createdAt(DEFAULT_CREATED_AT);
    }
    ...
    public static Comment createUpdatedEntity() {
        return new Comment().author(UPDATED_AUTHOR).content(UPDATED_CONTENT).createdAt(UPDATED_CREATED_AT);
    }
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.author(UPDATED_AUTHOR).content(UPDATED_CONTENT).createdAt(UPDATED_CREATED_AT);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.author(UPDATED_AUTHOR);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.author(UPDATED_AUTHOR).content(UPDATED_CONTENT).createdAt(UPDATED_CREATED_AT);
