...
import com.taskprionextforge.domain.enumeration.Priority;
...
class TaskResourceIT {
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.description(UPDATED_DESCRIPTION).status(UPDATED_STATUS).dueDate(UPDATED_DUE_DATE);
